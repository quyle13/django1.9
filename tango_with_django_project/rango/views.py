...
def visitor_cookie_handler(request):
    #request.COOKIES.get: no exist return default value

    visits = int (get_server_side_cookie(request,'visits','1'))
    last_visit_cookie = get_server_side_cookie(request,'last_visits',str(datetime.now()))
    #slice array: -7 go backward
